...
Footnote Format is a lightweight productivity add-on for Google Docs designed to give users granular control over footnote styling—a feature often missing in standard document settings.
...
Footnote Format's use and transfer of information received from Google APIs to any other app will adhere to the [Google API Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy), including the Limited Use requirements.
